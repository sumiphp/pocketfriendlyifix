...
<html class="no-js" lang="en">
	...
	<section>
		<div class="address-area">
			<div class="container">
				<div class="row">
					<div class="col-md-12 col-lg-12 contact-address">
						<div class="section-title wow animated fadeInUp" data-wow-duration="2s">
									<h2>Address</h2>
								</div>
								<div class="wow animated fadeInUp" data-wow-duration="2s" > 
								<p >A108 Adam Street <br>
									New York, NY 535022 <br>
									United States</p>

								<P> <strong><i class="fa fa-envelope"></i></strong> enquiry @axomlights.com<br></P>
								<P> <strong><i class='bx bxs-phone-call'></i></strong> +1234567891234<br></P>
							</div>
					</div>
				...
				<div class="row">
					<div class="col-md-12 col-lg-12 contact-address">
						...
						<div class="map-img mBot20 wow animated fadeInUp" data-wow-duration="2s" >
				...
				<div class="row">
					<div class="col-md-12 col-lg-12 get-in-touch-area">
						<div class="section-title wow animated fadeInUp" data-wow-duration="2s" >
							<h2>Quick Contact</h2>
						</div>
							...
							<form>
								...
								<div class="row">
									...
									<div class="form-group col-12 col-md-12 col-sm-12 col-xl-12">
											...
											<textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Enter Your Text"></textarea>
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-6 footer-links">
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6">
										<div class="logo-sec">
											<img src="<?php echo base_url().'assets/images/logo-footer.png';?>" class="footer-logo mtop-15">
										</div>
									</div>
								</div>
							</div>
