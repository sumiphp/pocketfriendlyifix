                                                          ...
                                                          <div class="row"> 
                                                            <div class="col-sm-12">
                                                              <div class="mb-3">
                                                                ...
                                                                <input class="form-control" placeholder="Enter Product Name" type="text" name="productcategory" data-bs-original-title="" title="" required ><span class="text-danger"></span>
                                                              </div>
                                                            </div>
                                                          </div>
                                                          <div class="row"> 
