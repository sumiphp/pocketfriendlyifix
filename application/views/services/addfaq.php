                                        ...
                                        <div class="inner-card">
                                            <div class="inner-card-body">
                                                <div class="product-info">
                                                    <form id="addfaq" class="rounded-form" method="post" >
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              <label for="company-name" class="form-label text-primary">Faq Title:</label>
                                                              <input type="text" class="form-control" id="faqtitle" name="faqtitle" placeholder="Enter Faq Title">
                                                      ...
                                                      <button type="button" class="btn btn-primary" id="uploadfaq" >Submit</button>
                                                  </form>
